...
public class RegisterController {
    ...
    public RegisterDto createRegisterWithPresence(RegisterDto registerDto, HttpServletRequest request){
    ...
    public RegisterDto addEntryToRegister(RegisterEntryDto registerEntryDto, HttpServletRequest request){
        Clock clock = systemUTC();
    ...
    @GetMapping()
    public RegisterDto getRegisterForChild(RegistrySearchCriteria registrySearchCriteria){
